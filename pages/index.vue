          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="pr-5">
                ...
                <div class="mt-5">
                  <nuxt-link to="/dashboard" class="btn btn-neutral my-2"
                    >Explore Dashboard</nuxt-link
                  >
                  <a
      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img
              src="~/static/img/theme/landing-1.png"
              class="img-fluid"
              alt="Landing image"
            />
          </div>
    ...
    <section class="py-6">
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6">
            <img
              src="~/static/img/theme/landing-2.png"
              class="img-fluid"
              alt="Landing image 2"
            />
          </div>
    ...
    <section class="py-6">
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img
              src="~/static/img/theme/landing-3.png"
              class="img-fluid"
              alt="Landing image 3"
            />
          </div>
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              ...
              <nuxt-link to="/widgets" class="font-weight-bold text-info mt-5"
                >Explore widgets</nuxt-link
              >
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              <a
                href="https://demos.creative-tim.com/nuxt-argon-dashboard-pro/documentation/foundation/icons.html"
        ...
        <div class="blur--hover">
          ...
          >
            ...
            <span class="blur-hidden h5 text-success"
              >Eplore all the 21.000+ Nucleo Icons</span
            >
          </a>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row row-grid justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              <a
                href="https://www.creative-tim.com/product/nuxt-argon-dashboard?ref=nvadp-index-page"
              ...
              <a
                href="https://www.creative-tim.com/product/nuxt-argon-dashboard-pro?ref=vadp-index-page"
            ...
            <div class="text-center">
              ...
              <div class="row justify-content-center">
                <div class="col-md-2 col-3 my-2">
                  ...
                  >
                    <a
                      href="https://www.creative-tim.com/product/argon-dashboard?ref=nvadp-index-page"
                      target="_blank"
                      rel="noopener"
                ...
                <div class="col-md-2 col-3 my-2">
                  <el-tooltip
                    placement="top"
                    content="[Coming Soon] Sketch - Digital design toolkit"
                  >
                    <a
                ...
                <div class="col-md-2 col-3 my-2">
                  <el-tooltip
                    placement="top"
                    content="Angular - One framework. Mobile "
                  >
                    <a
                      href="https://www.creative-tim.com/product/argon-dashboard-angular?ref=nvadp-index-page"
                      target="_blank"
                      rel="noopener"
                      aria-label="Angular"
                    >
                ...
                <div class="col-md-2 col-3 my-2">
                  ...
                  >
                    <a
                      href="https://www.creative-tim.com/product/argon-dashboard-react?ref=nvadp-index-page"
                      target="_blank"
                      rel="noopener"
                      aria-label="React"
                    >
