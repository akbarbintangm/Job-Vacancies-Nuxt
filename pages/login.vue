      ...
      <div class="container">
        ...
        <div class="header-body text-center mb-7">
          <div class="text-center" style="margin-bottom: 5px">
            <h1 class="text-white">
              Log in to Job Vacancies Management Website
            </h1>
            <p class="text-lead text-white">
              Log in to view Job Vacancies Management Website.
            </p>
          </div>
          <div class="text-white">
            ...
            <div>
              Username <b>administrator@gmail.com</b> Password <b>adminadmin</b>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form class="needs-validation" @submit.prevent="handleSubmit()">
                ...
                <div class="text-center">
                  ...
                  @submit.prevent="handleSubmit()">Sign in</base-button
                  >
                </div>
              </form>
            </div>
